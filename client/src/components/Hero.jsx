  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(./assets/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        <button className='bg-[#5044E5] text-white px-10 py-3 rounded-lg hover:scale-102 active:scale-95 transition cursor-pointer' onClick={() => navigate('/ai')}>Start creating now</button>
